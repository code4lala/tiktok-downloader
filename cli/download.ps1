...
Function GUI_TextBox ($Input_Type){
    ...
    $form.Text = '输入视频链接，可以输入多个，用逗号隔开就好了' ### Text to be displayed in the title
    $form.Size = New-Object System.Drawing.Size(500,280) ### Size of the window
    ...
    $OKButton.Location = New-Object System.Drawing.Point(155,200) ### Location of where the button will be
    ...
    $CancelButton.Location = New-Object System.Drawing.Point(70,200) ### Location of where the button will be
    ...
    $textBox.Size = New-Object System.Drawing.Size(460,150) ### Size of the text box
...
###############################################################################
$Computers = GUI_TextBox "视频链接:" ### Calls the text box function with a parameter and puts returned input in variable
